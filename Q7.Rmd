...
```{r}
#Import class one survey data from Kim's Github site (https://github.com/kijohnson/ADA-2024)
...
duplicates <- class_SA_csv1[duplicated(class_SA_csv1), ]
...
```{r}
# Check rows where bmonth is NA
na_rows <- class_SA_csv1[is.na(class_SA_csv1$bmonth), ]
na_rows

```

```{r}
# Check for blank strings or unusual 'NA' representations
summary(class_SA_csv1$bmonth)

```

```{r}
# Filter out rows where bday is 31
