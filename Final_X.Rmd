...
#There are 48 males and 59 females in the original dataset.
...
# The odds of having "Moderate improvement" to "Considerable improvement" as a radiological outcome are 5.26 times (95% CI: 2.55–11.17) the odds of death to no change as outcome, for patients in the Streptomycin arm compared to patients in the Control arm. 
...
# The presence of diabetes is associated with a hazard of death that is 2.12  times higher  compared to those without diabetes, adjusted for smoking status and age.
```
...
# The hazard of death in current smokers with diabetes is 1.07 (95% CI: 0.79–1.45) times higher  compared to non-current smokers, after adjusting for age. 
# The hazard of death in current smokers without diabetes is 1.66 (95% CI: 1.48–1.86) times higher  compared to non-current smokers, after adjusting for age. 
```
...
#The hazard of death in current smokers without diabetes is 1.64 (95% CI: 1.46–1.83) times higher compared to non-current smokers. 
