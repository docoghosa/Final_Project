...
```{r}
#Confirm removal of missing values was successful
...
```{r}
#Export the flowchart as a png file named 'flowchart_large' with dimensions as shown
...
```
Individuals who engaged in frequent physical activity "times per week" had 1.22 times higher odds of reporting excellent health compared to those who engaged in less frequent physical activity "times per month."
...
bp_test
```
Interpretation: The heteroscedasticity persists despite the log transformation. Hence, the heteroscedasticity likely arose from factors unrelated to the scale of the variables (physicl activity).
